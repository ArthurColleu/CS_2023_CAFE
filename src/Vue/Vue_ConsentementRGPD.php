...
<form action='/Controleur/Controleur_visiteur.php'  method='post'>
    <input type='hidden' name='case' value='RGPD'>
    <button name='accepte_RGPD' type='submit'>Accepter</button>
    <button name='refuser_RGPD' type='submit'>Refuser</button>
</form>";
